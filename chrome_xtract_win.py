...
-----
  ...
  python chrome_xtract_win.py -Browser firefox -Output passwords.csv -HideBanner
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="chrome_xtract_win.py - Browser Password Extractor",
